...
prob_below_30000 = 1 - prob_above_30000
...
print(f"  Simulations where final balance > $30,000: {prob_above_30000 * 100:.1f}%")
print(f"  Simulations where final balance ≤ $30,000: {prob_below_30000 * 100:.1f}%")
print(f"\nOut of 100 simulations:")
print(f"  Above initial investment: {int(prob_above_30000 * 100)} simulations")
print(f"  Below or equal to initial investment: {int(prob_below_30000 * 100)} simulations")
```
